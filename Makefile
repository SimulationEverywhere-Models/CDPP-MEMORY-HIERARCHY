...
LDFLAGS += -L.
#^|
EXAMPLESOBJS=  cachel1.o cachel2.o centralprocessingunit.o mainmemory.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#-
...
#^|
cachel1.o: /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel1.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cachel2.o: /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel2.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
centralprocessingunit.o: /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/centralprocessingunit.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
mainmemory.o: /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/mainmemory.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
cachel1.o: \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel1.cpp \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel1.h \
...
cachel2.o: \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel2.cpp \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/cachel2.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/loader.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/ltranadm.h
centralprocessingunit.o: \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/centralprocessingunit.cpp \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/centralprocessingunit.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/ltranadm.h
mainmemory.o: \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/mainmemory.cpp \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/mainmemory.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/ltranadm.h
register.o: \
 /cygdrive/C/eclipse/workspace/LeastedRecentlyUsed/register.cpp \
